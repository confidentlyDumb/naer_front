<template>
  ...
  >
    <div class="py-4 text-gray-500 dark:text-gray-400" id="sidebar">
      <a
      ...
      <ul class="mt-6 pt-px">
        <li class="relative px-6 py-3 mt-px border-t dark:border-gray-700 border-gray-200">
          <span
            class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
            aria-hidden="true" id="indicator"
          ></span>
          <a
        ...
        <li class="relative px-6 py-3">
          ...
          >
            ...
            <svg class="w-5 h-5"
                 ...
                 stroke-linejoin="round"
                 stroke-width="2"
                 viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
