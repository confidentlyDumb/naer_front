  ...
  <div class="container px-6 mx-auto">
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2">
      ...
      <div class="w-1/2 relative -mt-10 flex flex-col">
        ...
        <button class="mt-6 flex items-center justify-center self-center px-10 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-purple" onclick="openModal('createField')">Create field</button>
