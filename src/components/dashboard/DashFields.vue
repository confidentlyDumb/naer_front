<template>
  <div class="container px-6 mx-auto">
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2">
      <div href="/dashboard/field/?id="
        class="rp-4 bg-white rounded-lg shadow-xs dark:bg-gray-800  transition duration-300 dark:hover:bg-blue-500 hover:bg-blue-500 dark:hover:text-white hover:text-white"
      >
      <div
