...
<template>
    ...
    <div class="h-32 md:h-auto md:w-1/2">
        ...
        <div class="w-full">
            ...
            <a
            class="block w-full px-4 py-2 my-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
            href="/"
            >
            Create account
            </a>
